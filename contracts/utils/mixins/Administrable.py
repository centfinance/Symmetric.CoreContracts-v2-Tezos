...
class Administrable:
    def __init__(self, administrator, include_views=True):
        self.update_initial_storage(
            ...
            proposed_administrator=sp.set_type_expr(
        ...
        if include_views:
            ...
            self.get_administrator = sp.onchain_view(
                pure=True)(get_administrator)
    ...
    def accept_administrator(self):
        ...
        sp.verify(sp.some(sp.sender) == self.data.proposed_administrator,
