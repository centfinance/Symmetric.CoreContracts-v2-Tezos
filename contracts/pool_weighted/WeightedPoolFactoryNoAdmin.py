...
from contracts.pool_utils.BasePoolFactoryNoAdmin import BasePoolFactoryNoAdmin
...
class WeightedPoolFactoryNoAdmin(
    sp.Contract,
):
    ...
    def __init__(
        ...
        BasePoolFactoryNoAdmin.__init__(
            self,
            vault,
            protocolFeeProvider,
        )
...
sp.add_compilation_target('WeightedPoolFactoryNoAdmin', WeightedPoolFactoryNoAdmin())
