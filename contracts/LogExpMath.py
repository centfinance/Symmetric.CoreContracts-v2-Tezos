...
# # 256 bit integer.
# LN_36_LOWER_BOUND = ONE_18 - 1e17
# LN_36_UPPER_BOUND = ONE_18 + 1e17
...
#         logx_times_y = ((ln_36_x / ONE_18) * y +
#                         ((ln_36_x % ONE_18) * y) / ONE_18)
#     with sp.else_():
...
#     sp.verify(MIN_NATURAL_EXPONENT <= logx_times_y & logx_times_y <= MAX_NATURAL_EXPONENT,
#               Errors.PRODUCT_OUT_OF_BOUNDS)

#     sp.result(exp(logx_times_y))
...
#     term.value = ((term.value * x) / ONE_20) / 2
#     seriesSum.value += term.value

#     term.value = ((term.value * x) / ONE_20) / 3
#     seriesSum.value += term.value

#     term.value = ((term.value * x) / ONE_20) / 4
#     seriesSum.value += term.value

#     term.value = ((term.value * x) / ONE_20) / 5
#     seriesSum.value += term.value

#     term.value = ((term.value * x) / ONE_20) / 6
#     seriesSum.value += term.value

#     term.value = ((term.value * x) / ONE_20) / 7
#     seriesSum.value += term.value

#     term.value = ((term.value * x) / ONE_20) / 8
#     seriesSum.value += term.value

#     term.value = ((term.value * x) / ONE_20) / 9
#     seriesSum.value += term.value

#     term.value = ((term.value * x) / ONE_20) / 10
#     seriesSum.value += term.value

#     term.value = ((term.value * x) / ONE_20) / 11
#     seriesSum.value += term.value

#     term.value = ((term.value * x) / ONE_20) / 12
#     seriesSum.value += term.value
...
#     sp.result((((product * seriesSum.value) / ONE_20) * firstAN.value) / 100)
...
#     def _ln(a):
#         with sp.if_(a < ONE_18):
#             # Since ln(a^k) = k * ln(a), we can compute ln(a) as ln(a) = ln((1/a)^(-1)) = - ln((1/a)). If a is less
#             # than one, 1/a will be greater than one, and this if statement will not be entered in the recursive call.
#             # Fixed point division requires multiplying by ONE_18.
#             sp.result(-_ln((ONE_18 * ONE_18) / a))
...
#         sum = sp.local('sum', 0)
#         with sp.if_(a >= a0 * ONE_18):
#             a /= a0  # Integer, not fixed point division
#             sum.value += x0

#         with sp.if_(a >= a1 * ONE_18):
...
#         sp.result(sum.value + seriesSum) / 100
