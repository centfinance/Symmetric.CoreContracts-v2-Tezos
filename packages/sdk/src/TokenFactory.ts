...
async function example() {
  ...
  try {
    ...
    token0.set("name", char2Bytes("cTEZ"));
    token0.set("symbol", char2Bytes("CTEZ"));
    token0.set("decimals", "18");
    const token1 = new MichelsonMap();
    token1.set("name", char2Bytes("tzBTC"));
    token1.set("symbol", char2Bytes("tzBTC"));
    token1.set("decimals", "18");
    const token2 = new MichelsonMap();
    token2.set("name", char2Bytes("Tether"));
    token2.set("symbol", char2Bytes("USDT"));
    token2.set("decimals", "18");
    const token3 = new MichelsonMap();
    token3.set("name", char2Bytes("Wrapped Tez"));
    token3.set("symbol", char2Bytes("wTEZ"));
    token3.set("decimals", "18");
    const token4 = new MichelsonMap();
    token4.set("name", char2Bytes("Symmetric"));
